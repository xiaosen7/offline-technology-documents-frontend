(window.webpackJsonp=window.webpackJsonp||[]).push([[214],{3916:function(s,n){s.exports={content:["article",["p","Ant Design allows you to customize our design tokens to satisfy UI diversity from business or brand requirements, including primary color, border radius, border color, etc."],["p",["img",{title:null,src:"https://zos.alipayobjects.com/rmsportal/zTFoszBtDODhXfLAazfSpYbSLSEeytoG.png",alt:"customized themes"}]],["h2","Ant Design Less variables"],["p","We are using ",["a",{title:null,href:"http://lesscss.org/"},"Less"]," as the development language for styling. A set of less variables are defined for each design aspect that can be customized to your needs."],["p","There are some major variables below, all less variables could be found in ",["a",{title:null,href:"https://github.com/ant-design/ant-design/blob/4.x-stable/components/style/themes/default.less"},"Default Variables"],"."],["pre",{lang:"less",highlighted:`<span class="token variable">@primary-color<span class="token punctuation">:</span></span> <span class="token hexcode">#1890ff</span><span class="token punctuation">;</span> <span class="token comment" spellcheck="true">// primary color for all components</span>
