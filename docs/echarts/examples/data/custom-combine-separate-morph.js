...
$.when(
  $.getScript(
    "/third-party/cdn.jsdelivr.net/npm/echarts-simple-transform/dist/ecSimpleTransform.min.js"
  ),
  $.getScript(
    "/third-party/cdn.jsdelivr.net/npm/echarts-simple-option-player/dist/ecSimpleOptionPlayer.min.js"
  )
).done(function () {
  run();
});
