!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t) {
      ...
      function r(e) {
        ...
        if (t) {
            ...
            i = (function (e, t) {
              ...
              if (e.isWindow(t))
                ...
                (r = g + s * m - t.clientWidth * m),
                  ...
                  (a = Math.max(
                    Math.min(a, t.scrollHeight - t.clientHeight),
                    0
                  )),
                  (i = r - t.scrollLeft),
                  (o = a - t.scrollTop);
          ...
          if (t.endIterations >= a)
            return (
              n(e, i.x, i.y), (e._scrollSettings = null), t.end("complete")
            );
          var l = 1 - t.ease(s);
          if (
            (n(e, i.x - i.differenceX * l, i.y - i.differenceY * l),
            o >= t.time)
          )
            return t.endIterations++, r(e);
          !(function (e) {
      ...
      function i(e, t, n, i) {
        ...
        function h(e) {
          (t._scrollSettings = null),
            ...
            i(e),
            o &&
              (t.removeEventListener("touchstart", o, u),
              t.removeEventListener("wheel", o, u));
        }
        l && l.end("canceled");
        ...
        null == p && (p = 3),
          ...
          ("cancellable" in n && !n.cancellable) ||
            ((o = h.bind(null, "canceled")),
            t.addEventListener("touchstart", o, u),
            t.addEventListener("wheel", o, u)),
          s && r(t);
      }
      function o(e) {
        return (
      ...
      e.exports = function (e, t, n) {
        if (e) {
          ...
          for (
            ...
            if (
              (t.debug && console.log("Scrolling parent node", r),
              c(r, a) && (u ? u(r, o) : o(r)) && (a++, i(e, r, t, h)),
              !(r = l(r)))
            ) {
              h("complete");
              break;
    ...
    function (e, t, n) {
      (function (t) {
        ...
        function d(e, t, n) {
          ...
          function y(e) {
            return (c = e), (s = setTimeout(x, t)), u ? _(e) : o;
          }
          function b(e) {
            var n = e - l;
          ...
          function E(e) {
            return (s = void 0), g && r ? _(e) : ((r = a = void 0), o);
          }
          function w() {
            var e = f(),
              n = b(e);
            if (((r = arguments), (a = this), (l = e), n)) {
              ...
              if (d) return (s = setTimeout(x, t)), _(l);
            }
        ...
        e.exports = function (e, t, n) {
          ...
          return (
            ...
            d(e, t, { leading: r, maxWait: t, trailing: a })
          );
        };
      }).call(this, n(22));
    },
    function (e, t, n) {
      ...
      (a = function (e) {
        ...
        function g(e) {
          return (
            ...
            e.cached_variants
              ...
              ? [m(e, { starts: e.starts ? m(e.starts) : null })]
              : Object.isFrozen(e)
              ? [m(e)]
              : [e]
          );
        ...
        function _(e, t) {
          return t
            ? Number(t)
            : ((n = e), -1 != h.indexOf(n.toLowerCase()) ? 0 : 1);
          var n;
        }
        function y(e) {
          function t(e) {
          ...
          function a(e) {
            ...
            for (var u = 0; u < e.contains.length; u++)
              c(
                (a = e.contains[u]),
                a.beginKeywords ? "\\.?(?:" + a.begin + ")\\.?" : a.begin
              );
            ...
            return (
              ...
              (s.exec = function (t) {
                ...
                return (
                  "string" == typeof r
                    ? ((a.type = r), (a.extra = [e.illegal, e.terminator_end]))
        ...
        function b(e, t, n, a) {
            ...
            (S +=
              null != w.subLanguage
                ? (function () {
                    ...
                    if (e && !r[w.subLanguage]) return p(O);
                    var t = e
                      ? b(w.subLanguage, O, !0, C[w.subLanguage])
                      : x(O, w.subLanguage.length ? w.subLanguage : void 0);
                    return (
                      w.relevance > 0 && (M += t.relevance),
                      e && (C[w.subLanguage] = t.top),
                      l(t.language, t.value, !1, !0)
                    );
                  })()
                : (function () {
                    var e, t, n, r;
                    if (!w.keywords) return p(O);
                    for (
                      r = "",
                        t = 0,
                        w.lexemesRe.lastIndex = 0,
                        n = w.lexemesRe.exec(O);
                      n;

                    )
                      (r += p(O.substring(t, n.index))),
                        (e = s(w, n))
                          ? ((M += e[1]), (r += l(e[0], p(n[0]))))
                          : (r += p(n[0])),
                        (t = w.lexemesRe.lastIndex),
                        (n = w.lexemesRe.exec(O));
                    return r + p(O.substr(t));
                  })()),
              (O = "");
          }
          function f(e) {
            (S += e.className ? l(e.className, "", !0) : ""),
          ...
          function m(e) {
            ...
            if (r) {
              ...
              a.skip
                ? (O += t)
                : (a.returnEnd || a.excludeEnd || (O += t),
                  h(),
                  a.excludeEnd && (O = t));
              do {
                w.className && (S += "</span>"),
                  w.skip || w.subLanguage || (M += w.relevance),
                  (w = w.parent);
              } while (w !== r.parent);
              return (
                r.starts &&
                  (r.endSameAsBegin && (r.starts.endRe = r.endRe), f(r.starts)),
          ...
          function g(e, t) {
            ...
            if (
              ...
              return (O += o.slice(t.index, t.index + 1)), 1;
            if (((v = t), "begin" === t.type)) return d(t);
            if ("illegal" === t.type && !n)
              throw new Error(
                'Illegal lexeme "' +
                  r +
          ...
          var E,
            ...
            C = {},
            S = "";
          for (E = w; E !== _; E = E.parent)
            E.className && (S = l(E.className, "", !0) + S);
          var O = "",
            M = 0;
          try {
            for (
              var N, T, I = 0;
              (w.terminators.lastIndex = I), (N = w.terminators.exec(o));

            )
              (T = g(o.substring(I, N.index), N)), (I = N.index + T);
            for (g(o.substr(I)), E = w; E.parent; E = E.parent)
              E.className && (S += "</span>");
            return { relevance: M, value: S, illegal: !1, language: e, top: w };
          } catch (t) {
            if (t.message && -1 !== t.message.indexOf("Illegal"))
              return { illegal: !0, relevance: 0, value: p(o) };
            if (i)
              return {
                relevance: 0,
                value: p(o),
        ...
        function w(e) {
          ...
          d(h) ||
            ...
            (i = h ? b(h, l, !0) : x(l)),
            (r = v(n)).length &&
              (((o = document.createElement("div")).innerHTML = i.value),
    ...
    function (e, t, n) {
      ...
      !(function (i, s) {
        "object" === o(t) && void 0 !== e
          ? (e.exports = s())
          : void 0 ===
              (a = "function" == typeof (r = s) ? r.call(t, n, t, e) : r) ||
            (e.exports = a);
      })(0, function () {
        "use strict";
        var e = "undefined" != typeof window,
          ...
          f = function (e, t) {
            (e.loadingCount += t),
              0 === e._elements.length &&
                0 === e.loadingCount &&
                p(e._settings.callback_finish, e);
          },
          d = function (e) {
          ...
          v = function (e, t) {
            m(e, "sizes", s(e, t.data_sizes)),
              m(e, "srcset", s(e, t.data_srcset)),
                ...
                function (t) {
                  t.forEach(function (t) {
                    return (function (e) {
                      ...
                      : (function (e, t, n) {
                          var r = n._settings;
                          p(r.callback_exit, e, t, n), r.load_delay && k(e);
                        })(t.target, t, e);
                  });
                },
                {
              ...
              e &&
                window.addEventListener("online", function (e) {
                  !(function (e) {
                    var t = e._settings;
                    t.container
                      .querySelectorAll("." + t.class_error)
                      .forEach(function (e) {
                        y(e, t.class_error),
                          (function (e) {
                  ...
                  ? ((function (e) {
                      ...
                      ((n = this)._elements.forEach(function (e) {
                        -1 !== N.indexOf(e.tagName) &&
                          (e.setAttribute("loading", "lazy"), O(e, n));
                      }),
                      (this._elements = T(e, a))),
                  ...
                  },
                  {
                    ...
                    value: function (e, t, n) {
                      ...
                      e.addEventListener("load", o),
                        (i = setTimeout(o, this.iframesTimeout));
                    },
                  },
                  {
                    key: "onIframeReady",
                  ...
                  value: function (e, t, n, r, a) {
                    ...
                    this.getTextNodes(function (t) {
                      t.nodes.forEach(function (t) {
                        ...
                        for (
                          var a = void 0;
                          null !== (a = e.exec(t.textContent)) && "" !== a[o];

                        )
                          if (n(a[o], t)) {
                            var s = a.index;
                            if (0 !== o)
                              for (var l = 1; l < o; l++) s += a[l].length;
                            (t = i.wrapRangeInTextNode(t, s, s + a[o].length)),
                              r(t.previousSibling),
                              (e.lastIndex = 0);
                          }
                      }),
                ...
                },
                {
                  ...
                  value: function (e, t, n, r, a) {
                    ...
                    this.getTextNodes(function (t) {
                      for (
                        var s = void 0;
                        null !== (s = e.exec(t.value)) && "" !== s[o];

                      ) {
                        var l = s.index;
                        if (0 !== o)
                          for (var c = 1; c < o; c++) l += s[c].length;
                        var u = l + s[o].length;
      ...
      (function (t) {
        ...
        e.exports = function (e, t, n) {
          ...
          function w() {
            ...
            if (((r = arguments), (a = this), (l = e), n)) {
              if (void 0 === s) return y(l);
              if (v) return (s = setTimeout(x, t)), _(l);
            }
            return void 0 === s && (s = setTimeout(x, t)), o;
          }
          return (
            ...
            d(n) &&
              ((u = !!n.leading),
              (i = (v = "maxWait" in n) ? h(m(n.maxWait) || 0, t) : i),
              (g = "trailing" in n ? !!n.trailing : g)),
            (w.cancel = function () {
              void 0 !== s && clearTimeout(s),
                (c = 0),
    ...
    function (e, t, n) {
      ...
      function _(e) {
        for (
          ...
          if (null != a) {
            var i = void 0;
            for (i in a)
              g(a, i) && (l(a[i]) ? (n[i] = _(n[i], a[i])) : (n[i] = a[i]));
          }
        }
        return n;
      }
            ...
            c(n.format)
              ...
              : l(n.format) &&
                ...
                (u = Object.keys(n.format).reduce(function (e, t) {
                  var r;
                  return m(i, t)
                    ? Object.assign({}, e, (((r = {})[t] = n.format[t]), r))
                    : e;
                }, null)));
      ...
      function I(e, t, n) {
        var r,
          ...
          i = (function (e) {
            ...
            c(e)
              ? (t = e)
              : h(e) &&
                ((t = e.path), (n = e.locale), (r = e.args), (a = e.choice));
        ...
        if (s || l || u)
          if (s) {
            ...
            (e._vt = e.textContent =
              null != p
                ? (r = f.$i18n).tc.apply(r, [s, p].concat(R(l, u)))
                : (a = f.$i18n).t.apply(a, [s].concat(R(l, u)))),
      ...
      function A(e) {
        A.installed = !0;
        (S = e).version && Number(S.version.split(".")[0]);
        (function (e) {
          e.prototype.hasOwnProperty("$i18n") ||
            ...
            (e.prototype.$tc = function (e, t) {
              ...
              return a._tc.apply(
                a,
                [e, a.locale, a._getMessages(), this, t].concat(n)
              );
            }),
          ...
          S.mixin(b),
          S.directive("t", { bind: O, update: M, unbind: N }),
          S.component(x.name, x),
          S.component(k.name, k),
          (S.config.optionMergeStrategies.i18n = function (e, t) {
            return void 0 === t ? e : t;
          });
      }
      var L = function () {
      ...
      var D = /^(?:\d)+/,
        $ = /^(?:\w)+/;
      var P = [];
      (P[0] = { ws: [0], ident: [3, 0], "[": [4], eof: [7] }),
        (P[1] = { ws: [1], ".": [2], "[": [4], eof: [7] }),
        (P[2] = { ws: [2], ident: [3, 0], 0: [3, 0], number: [3, 0] }),
        (P[3] = {
          ident: [3, 0],
          0: [3, 0],
          number: [3, 0],
        ...
        (P[5] = { "'": [4, 0], eof: 8, else: [5, 0] }),
        (P[6] = { '"': [4, 0], eof: 8, else: [6, 0] });
      ...
      function F(e) {
        ...
        return (
          ...
          ((r = a),
          V.test(r)
            ? (n = (t = a).charCodeAt(0)) !== t.charCodeAt(t.length - 1) ||
              (34 !== n && 39 !== n)
              ? t
              : t.slice(1, -1)
            : "*" + a)
          ...
          t ||
            ((t = (function (e) {
              ...
              for (
                ...
                if ((c++, "\\" !== (t = e[c]) || !f())) {
                  if (((a = j(t)), 8 === (i = (s = P[u])[a] || s.else || 8)))
                    return;
                  if (
                    ((u = i[0]),
                    (o = p[i[1]]) &&
                      ((r = void 0 === (r = i[2]) ? t : r), !1 === o()))
                  )
                    return;
                  if (7 === u) return l;
                }
      ...
      var B,
        ...
        J = function (e) {
          var t = this;
          void 0 === e && (e = {}),
            !S && "undefined" != typeof window && window.Vue && A(window.Vue);
      ...
      (J.prototype._checkLocaleMessage = function (e, t, n) {
        var r = function (e, t, n, a) {
          if (h(n))
            Object.keys(n).forEach(function (i) {
              var o = n[i];
              h(o)
                ? (a.push(i), a.push("."), r(e, t, o, a), a.pop(), a.pop())
                : (a.push(i), r(e, t, o, a), a.pop());
            });
        ...
        (J.prototype._initVM = function (e) {
          var t = S.config.silent;
          (S.config.silent = !0),
            (this._vm = new S({ data: e })),
            (S.config.silent = t);
        }),
        ...
        (J.prototype._warnDefault = function (e, t, n, r, a, i) {
          if (!p(n)) return n;
          if (this._missing) {
        ...
        (J.prototype._interpolate = function (e, t, n, r, a, i, o) {
          if (!t) return null;
          var s,
          ...
          return (
            (s.indexOf("@:") >= 0 || s.indexOf("@.") >= 0) &&
              (s = this._link(e, t, s, r, "raw", i, o)),
            this._render(s, a, i, n)
          );
        }),
        (J.prototype._link = function (e, t, n, r, a, i, o) {
          var s = n,
            l = s.match(U);
          for (var c in l)
        ...
        (J.prototype._render = function (e, t, n, r) {
          ...
          return (
            a || (a = K.interpolate(e, n, r)),
            "string" !== t || c(a) ? a : a.join("")
          );
        }),
        ...
        (J.prototype._getLocaleChain = function (e, t) {
          ...
          if (!n) {
            ...
            (a = c((r = s(t) ? t : l(t) ? (t.default ? t.default : null) : t))
              ? [r]
              : r) && this._appendBlockToChain(n, a, null),
              (this._localeChainCache[e] = n);
          }
          return n;
        }),
        (J.prototype._translate = function (e, t, n, r, a, i, o) {
          for (
            var s, l = this._getLocaleChain(t, n), c = 0;
            c < l.length;
            c++
          ) {
            var u = l[c];
        ...
        (J.prototype._t = function (e, t, n, r) {
          ...
          return (
            (c = this._warnDefault(l, e, c, r, i, "string")),
        ...
        (J.prototype._i = function (e, t, n, r, a) {
        ...
        (J.prototype._tc = function (e, t, n, r, a) {
        ...
        (J.prototype._localizeDateTime = function (e, t, n, r, a) {
          for (
            var i = t, o = r[i], s = this._getLocaleChain(t, n), l = 0;
            l < s.length;
            l++
          ) {
            var c = s[l];
          ...
          return (
            f ||
              (f = this._dateTimeFormatters[h] = new Intl.DateTimeFormat(i, u)),
            f.format(e)
          );
        }),
          ...
          return (
            1 === t.length
              ? c(t[0])
                ? (a = t[0])
                : l(t[0]) &&
                  (t[0].locale && (r = t[0].locale), t[0].key && (a = t[0].key))
              : 2 === t.length &&
                (c(t[0]) && (a = t[0]), c(t[1]) && (r = t[1])),
            this._d(e, r, a)
          );
        }),
        ...
        (J.prototype._getNumberFormatter = function (e, t, n, r, a, i) {
          for (
            var o = t, s = r[o], l = this._getLocaleChain(t, n), c = 0;
            c < l.length;
            c++
          ) {
            var u = l[c];
        ...
        Z = function () {
          ...
          return n(
            "el-container",
            {
              class: [
                "ec-doc",
                "ec-doc-" + e.shared.docType,
                "ec-doc-locale-" + e.shared.locale,
              ],
            },
            [
              n(
                ...
                [
                  n("div", { staticClass: "doc-type-nav" }, [
                    n(
                      "a",
                      {
                        class: { selected: "option" === e.shared.docType },
                    ...
                    n(
                      "a",
                      {
                        class: { selected: "api" === e.shared.docType },
                    ...
                    n(
                      "a",
                      {
                        class: { selected: "tutorial" === e.shared.docType },
                    ...
                    n(
                      "a",
                      {
                        class: { selected: "option-gl" === e.shared.docType },
              ...
              n(
                "el-main",
                [
                  e.shared.fuzzySearch
                    ? n("SearchResult")
                    : n("DocContent", { key: e.pagePath }),
                ],
                1
              ),
            ],
          ...
          [
            ...
            n("div", { staticClass: "toolbox" }, [
              e.isOption
                ? n(
                    "span",
                    { staticClass: "item", on: { click: e.collapseAll } },
                    [
                    ...
                    fn: function (t) {
                      ...
                      return "tutorial" !== e.shared.docType
                        ? n("div", { staticClass: "doc-nav-item" }, [
                            n("span", [
                              e._v(
                                e._s((r.expanded && a.labelExpanded) || a.label)
                              ),
                            ]),
                            e._v(" "),
                            null != a.defaultValue
                              ? n("span", { staticClass: "default-value" }, [
                                  e._v(e._s(a.defaultValue)),
                                ])
                              : r.isLeaf
                              ? n("span", { staticClass: "default-value" }, [
                                  e._v("..."),
          ...
          re ||
            (re = pe("".concat(te, "-outline.js")).then(function (e) {
              return (function (e) {
                ...
                function n(e, r) {
                  e.type || (e.type = oe(e.default)),
                    e.type instanceof Array || (e.type = [e.type]);
                  for (var a = 0; a < e.type.length; a++)
                    "*" === e.type[a] && (e.type[a] = "any");
                  if (
                    (e.arrayItemType
                      ? (e.path = t(r.path, e.arrayItemType, "-"))
                      : (e.path = t(r.path, e.prop, ".")),
                    e.children)
                  ) {
                    e.path.indexOf(".") < 0 &&
                      !e.children[0].arrayItemType &&
                      (se[e.path] = e);
      ...
      function Ee(e) {
        (ke.computedOptionExampleLayout =
          "auto" === e ? (window.innerWidth < 1400 ? "bottom" : "right") : e),
          (ke.optionExampleLayout = e),
          window.localStorage &&
            window.localStorage.setItem("_ec_option_example_layout", e);
      }
      var we,
        Ce,
        Se =
          ...
          !(Ce =
            window.localStorage &&
            window.localStorage.getItem("_ec_option_example_layout")) ||
          "auto" === Ce ||
          xe.indexOf(Ce) < 0
            ? ((we.mode = "auto"),
              (we.computedMode = window.innerWidth < 1400 ? "bottom" : "right"))
        ...
        ke = {
          ...
          optionExampleLayout: Se.mode,
          computedOptionExampleLayout: Se.computedMode,
        };
      function Oe() {
        if (ke.isMobile) {
          var e = ke.currentPath.split("."),
            t = _e(ke.currentPath);
          return (
            t && (!t.children || !t.children.length) && e.length > 1 && e.pop(),
            e.join(".")
          );
        }
        return ke.currentPath.split(".")[0];
      }
      function Me() {
        return "option" === ke.docType || "option-gl" === ke.docType;
      }
      var Ne = ["markPoint", "markLine", "markArea", "tooltip", "axisPointer"];
      function Te(e, t, n) {
        function r(e, t, a, i) {
          var o = t.shift();
          if (
        ...
        return "timeline" === a && e.baseOption
          ? Object.assign({}, e, {
              baseOption: r(e.baseOption, t.split("."), "", ""),
            })
          : Ne.indexOf(a) >= 0
          ? (function e(n, a) {
      ...
      function Ie() {
        ...
        if (e.startsWith("/search/")) {
          ...
          (ke.fuzzySearch = !0), (ke.searchQuery = t);
        } else e && ((ke.currentPath = e), (ke.fuzzySearch = !1));
      }
      function Re(e) {
          ...
          t.children &&
            t.children.forEach(function (e) {
              ...
              n.push(
                ...
                t.arrayItemType
                  ? ((r.label = "{type: ".concat(t.arrayItemType, ", ...}")),
                    (r.labelExpanded = "{"))
                  : null != t.default
      ...
      var $e = {
        data: function () {
          return {
            ...
            loading: !0,
            shared: ke,
            initialSelectedNode: ke.currentPath,
          };
        },
        created: function () {
        ...
        methods: {
          updateTreeSelectionAndExpand: function () {
            this.expandedKeys = [];
            for (
              var e, t = this.shared.currentPath;
              (e = t.lastIndexOf(".")) >= 0 || (e = t.lastIndexOf("-")) >= 0;
          ...
          collapseAll: function () {
            for (var e in this.$refs.tree.store.nodesMap)
              this.$refs.tree.store.nodesMap[e].expanded = !1;
          },
        },
        watch: {
          "shared.currentPath": function (e) {
            Re(e), this.manualSelectNode(e);
          },
        },
      };
      n(31);
      function Pe(e, t, n, r, a, i, o, s) {
        var l,
      ...
      var Ve = Pe($e, Y, [], !1, null, null, null);
      Ve.options.__file = "src/components/DocNav.vue";
      var je = Ve.exports,
        Fe = function () {
          var e = this,
            t = e.$createElement,
              ...
              n(
                "div",
                {
                  ...
                  class: [
                    ...
                    "option-example-" +
                      e.shared.computedOptionExampleLayout +
                      "-layout",
                  ],
                },
                [
                  n("h2", { attrs: { id: e.pageId } }, [
                    e._v(e._s(e.pageTitle)),
                  ]),
                  e._v(" "),
                  e.pageDesc
                    ? n("div", {
                        ...
                        [
                          ...
                          e._l(e.pageDisplayOutline.children, function (t) {
                            return n("DocContentItemCard", {
                              ...
                              attrs: {
                                "node-data": t,
                                "desc-map": e.pageDescMap,
                                "max-depth": e.maxDepth,
                                depth: 1,
                              },
                              on: {
                                "scroll-to-self": e.scrollTo,
                                "toggle-expanded": e.handleCardExpandToggle,
                              },
                            });
                          }),
                        ],
                    ...
                    e.shared.showOptionExample
                      ...
                      : n(
                          "div",
                          {
                            ...
                            on: { click: e.openOptionExample },
                          },
                          [
                            n("i", { staticClass: "el-icon-data-line" }),
                            e._v(
                              " " +
                                e._s(e.$t("example.titleShort")) +
                                "\n        "
                            ),
                          ]
                        ),
          ...
          [
            ...
            n(
              ...
              [
                ...
                e.supportsExpandable
                  ? n("el-button", {
                      attrs: {
                        ...
                        circle: "",
                        size: "mini",
                        icon: e.expanded ? "el-icon-minus" : "el-icon-plus",
                      },
                ...
                e._v(" "),
                n("span", { staticClass: "path-base" }, [
                  n("a", { attrs: { href: "#" + e.baseName.link } }, [
                    e._v(e._s(e.baseName.text)),
                  ]),
                ]),
                e._v(" "),
                e.nodeData.default && "*" !== e.nodeData.default
                  ? n("span", { staticClass: "default-value" }, [
                      e._v(" = " + e._s(e.nodeData.default)),
                    ])
                  : e._e(),
                e._v(" "),
                e.uiControl && e.shared.allOptionExamples && !e.shared.isMobile
                  ? n(
                      "span",
                      {
                        class: [
                          "control-toggle",
                          e.enableUIControl ? "active" : "",
                        ],
                        on: { click: e.toggleUIControl },
                      },
                      [
                        n("i", [e._v("")]),
                        e._v(
                          " " + e._s(e.$t("example.tryDesc")) + "\n            "
                        ),
                      ]
                    )
                  : e._e(),
            ...
            n(
              ...
              e._l(e.nodeData.type, function (t) {
                return n(
                  ...
                  {
                    key: t,
                    class: ["prop-type", "prop-type-" + t.toLowerCase()],
                  },
                  [e._v(e._s(t))]
                );
              }),
            ...
            e.enableUIControl
              ? n("OptionControl", {
                  attrs: {
                    controlConfig: e.uiControl,
                    optionPath: e.nodeData.path,
                  },
                })
              : e._e(),
            e._v(" "),
                  ...
                  e._l(e.nodeData.children, function (t) {
                    return e.expanded
                      ? n("DocContentItemCard", {
                          ...
                          on: {
                            "toggle-expanded": e.bubbleEventToggleExapndedEvent,
                            "scroll-to-self": e.bubbleScrollToSelfEvent,
                          },
                        })
                      : e._e();
                  }),
            ...
            (e.expanded && !e.shared.isMobile) || e.isLeaf
              ? e._e()
              : n("PropertiesList", {
                  attrs: { nodeData: e.nodeData, descMap: e.descMap },
                }),
          ],
          1
        );
              ...
              e._l(e.displayedProperties, function (t, r) {
                return n(
                  ...
                  [
                    e.shared.isMobile
                      ? n("span", [
                          n(
                            "a",
                            {
                              attrs: { slot: "reference", href: "#" + t.path },
                              slot: "reference",
                            },
                    ...
                    e._v(" "),
                    r < e.displayedProperties.length - 1
                      ? n("span", [e._v(", ")])
                      : e._e(),
                  ],
                  1
      ...
      var We = {
        ...
        Ue = (n(32), Pe(We, Be, [], !1, null, null, null));
      ...
      var Ke = {
        ...
        Je = (n(33), Pe(Ke, Ge, [], !1, null, null, null));
      Je.options.__file = "src/controls/ControlColor.vue";
      var Qe = Je.exports,
        Xe = function () {
          var e = this,
            t = e.$createElement,
      ...
      var tt = {
        ...
        nt = (n(34), Pe(tt, et, [], !1, null, null, null));
          ...
          methods: {
            onValueChange: function () {
              if (!this.innerSeparate)
                for (var e = 1; e < this.innerValueArr.length; e++)
                  this.innerValueArr[e] = this.innerValueArr[0];
              this.$emit("change", this.innerValueArr.slice());
            },
          },
        },
        ot = (n(35), Pe(it, at, [], !1, null, null, null));
                ...
                e._l(e.optionsArr, function (t) {
                  return n(
                    "el-option",
                    {
                      key: t,
                      class: {
                        "control-enum-special": null != e.specialValues[t],
                      },
                      attrs: { value: t },
                    },
                    [e._v(e._s(t))]
      ...
      var ct = { true: !0, false: !1 },
        ut = {
          ...
          methods: {
            onValueChange: function () {
              this.$emit(
                "change",
                ct.hasOwnProperty(this.innerValue)
                  ? ct[this.innerValue]
                  : this.innerValue
              );
            },
        ...
        ht = (n(36), Pe(ut, lt, [], !1, null, null, null));
          ...
          return n(
            ...
            [
              n(
                ...
                [
                  n("el-radio-button", { attrs: { label: "absolute" } }, [
                    e._v(e._s(e.$t("example.absoluteMode"))),
                  ]),
                  e._v(" "),
                  n("el-radio-button", { attrs: { label: "percent" } }, [
                    e._v(e._s(e.$t("example.percentMode"))),
                  ]),
                ],
                1
              ),
      ...
      var dt = {
          ...
          watch: {
            value: function (e) {
              "absolute" === this.mode
                ? (this.absoluteValue = +e)
                : (this.percentValue = +e.replace("%", ""));
            },
            mode: function () {
              this.onValueChange();
            },
        ...
        mt = (n(37), Pe(dt, ft, [], !1, null, null, null));
      ...
      var _t = {
          ...
          methods: {
            onValueChange: function (e, t) {
              (this.innerValueArr[e] = t),
                this.$emit("change", this.innerValueArr.slice());
            },
          },
        },
        yt = (n(38), Pe(_t, gt, [], !1, null, null, null));
          ...
          return n(
            ...
            [
              n("el-input", {
                attrs: {
                  size: "mini",
                  placeholder: e.$t("example.inputPlaceholder"),
                },
                on: { change: e.onValueChange },
                model: {
                  value: e.innerValue,
          ...
          return n(
            ...
            [
              n(
                ...
                e._l(e.optionsArr, function (t) {
                  return n("el-option", { key: t, attrs: { value: t } }, [
                    e._v(e._s(t)),
                  ]);
                }),
                1
      ...
      var kt = /,?([achlmqrstvxz]),?/gi,
        Ot = function (e) {
          return e.join(",").replace(kt, "$1");
        };
          ...
          if (
              ...
              l = (function (e, t) {
                ...
                for (
                  var n = document.createElementNS(
                      e.ownerSVGElement.namespaceURI,
                      "path"
                    ),
                    r = [
                      "requiredFeatures",
              ...
              if (
                ...
                for (p = 1; p < s[i].length; p += 2)
                  "V" == g
                    ...
                    "V" == g || "H" == g
                      ? ((x[i][0] = "L"), (x[i][p] = f.x), (x[i][p + 1] = f.y))
                      : ((x[i][p] = f.x), (x[i][p + 1] = f.y));
              (("Z" != g && null === w.x) || "M" == g) &&
                ((w.x = y), (w.y = b)),
                "Z" == g && ((y = w.x), (b = w.y));
            }
            ...
            for (w.x = "", i = 0; i < x.length; i++) {
              if (
                ...
                var M = (N = x[i].length);
                if ("A" == _) (x[i][6] = T(x[i][6])), (x[i][7] = T(x[i][7]));
                else for (M--; --M; ) x[i][M] = T(x[i][M]);
                (C = x[i][N - 2]), (S = x[i][N - 1]);
              } else if ("a" == _)
                (k = x[i][6]),
                  (O = x[i][7]),
                ...
                var N = x[i].length;
                for (k = x[i][N - 2], O = x[i][N - 1], p = 1; p < N; p += 2)
                  (x[i][0] = "h" == _ || "v" == _ ? "l" : _),
                    (x[i][p] = T(x[i][p] - C)),
                    (x[i][p + 1] = T(x[i][p + 1] - S));
                (C = k), (S = O);
              ...
              (("z" != _.toLowerCase() && "" == w.x) ||
                "m" == _.toLowerCase()) &&
                ((w.x = C), (w.y = S)),
                "z" == _.toLowerCase() && ((C = w.x), (S = w.y));
            }
            n && (x = Kt(x)),
              l.setAttribute("d", Ot(x)),
              l.removeAttribute("transform");
          }
        function T(e) {
          return !1 !== a
            ? Math.round(e * Math.pow(10, a)) / Math.pow(10, a)
            : e;
        }
      }
      function Nt(e, t, n, r, a, i, o, s) {
        function l(e) {
        ...
        if (
          ...
          (b[3] = o.b * -u * p + o.d * u * f),
          (g =
            (d = b[0] * b[0] + b[2] * b[2]) - (v = b[1] * b[1] + b[3] * b[3])),
          ...
          var x = 1 + (m * m) / (g * g);
          (_ = 0.5 * (d + v + (x = x < 0 ? 0 : Math.sqrt(x)) * g)),
            (y = 0.5 * (d + v - x * g)),
            (n = 0.5 * Math.atan2(m, g));
        }
        return (
          (_ = _ < 0 ? 0 : Math.sqrt(_)),
          (y = y < 0 ? 0 : Math.sqrt(y)),
      ...
      var Tt = {},
        ...
        Lt = Rt.prototype.toLowerCase,
        Dt = Rt.prototype.toUpperCase,
        $t = Object.prototype.toString,
        Pt = "concat",
        Vt = Math,
        jt = Vt.max,
        Ft = (Vt.min, Vt.abs, Vt.pow, Vt.PI),
        zt = (Vt.round, parseFloat),
        Bt =
          (parseInt,
          (kt = /,?([achlmqrstvxz]),?/gi),
      ...
      (Tt.is = function (e, t) {
        return "finite" == (t = Lt.call(t))
          ...
          : ("null" == t && null === e) ||
            ...
            $t.call(e).slice(8, -1).toLowerCase() == t;
      }),
        (Tt._path2string = function () {
          return this.join(",").replace(kt, "$1");
        });
      var Ut = function (e) {
          var t = (function e(t) {
            if (Object(t) !== t) return t;
            var n = new t.constructor();
            for (var r in t) t[It](r) && (n[r] = e(t[r]));
            return n;
          })(e);
          return (t.toString = Tt._path2string), t;
        },
        Ht = function e(t) {
          var n = (e.ps = e.ps || {});
          return (
            ...
            setTimeout(function () {
              for (var e in n)
                n[It](e) &&
                  e != t &&
                  (n[e].sleep--, !n[e].sleep && delete n[e]);
            }),
            n[t]
          );
        };
      ...
      var Gt = function (e) {
        ...
        var n = {
          ...
          r = [];
        return (
          Tt.is(e, "array") && Tt.is(e[0], "array") && (r = Ut(e)),
          r.length ||
            Rt(e).replace(Bt, function (e, t, a) {
              var i = [],
                o = t.toLowerCase();
              if (
                (a.replace(Wt, function (e, t) {
                  t && i.push(+t);
                }),
                "m" == o &&
                  i.length > 2 &&
                  (r.push([t][Pt](i.splice(0, 2))),
                  (o = "l"),
                  (t = "m" == t ? "l" : "L")),
                "r" == o)
              )
                ...
                for (
                  ;
                  i.length >= n[o] &&
                  (r.push([t][Pt](i.splice(0, n[o]))), n[o]);

                );
            }),
          (r.toString = Tt._path2string),
          (t.arr = Ut(r)),
          r
        );
      };
      var Kt = Jt(function (e) {
        if (
          ((Tt.is(e, "array") && Tt.is(e && e[0], "array")) || (e = Gt(e)),
          !e || !e.length)
        )
          return [["M", 0, 0]];
        var t = [],
          ...
          o = 0;
        "M" == e[0][0] &&
          ((a = n = +e[0][1]), (i = r = +e[0][2]), o++, (t[0] = ["M", n, r]));
        for (
          var s,
            l,
            c =
          ...
          if ((t.push((s = [])), (l = e[u])[0] != Dt.call(l[0])))
            switch (((s[0] = Dt.call(l[0])), s[0])) {
              ...
              case "R":
                for (
                  var p = [n, r][Pt](l.slice(1)), f = 2, d = p.length;
                  f < d;
                  f++
                )
                  (p[f] = +p[f] + n), (p[++f] = +p[f] + r);
      ...
      var Qt = function (e, t, n, r) {
        ...
        Zt = Jt(function (e, t, n, r, a, i, o, s, l, c) {
          var u,
            h = (120 * Ft) / 180,
            p = (Ft / 180) * (+a || 0),
            f = [],
          ...
          if (c) (w = c[0]), (C = c[1]), (x = c[2]), (E = c[3]);
            ...
            (e = (u = d(e, t, -p)).x),
              ...
              (s = (u = d(s, l, -p)).x),
              (l = u.y);
            Math.cos((Ft / 180) * a), Math.sin((Ft / 180) * a);
            var m = (e - s) / 2,
              v = (t - l) / 2,
              g = (m * m) / (n * n) + (v * v) / (r * r);
            ...
            (w = e < x ? Ft - w : w) < 0 && (w = 2 * Ft + w),
              (C = s < x ? Ft - C : C) < 0 && (C = 2 * Ft + C),
              o && w > C && (w -= 2 * Ft),
              !o && C > w && (C -= 2 * Ft);
          }
          var S = C - w;
          if (Math.abs(S) > h) {
            ...
            (C = w + h * (o && C > w ? 1 : -1)),
              (s = x + n * Math.cos(C)),
              (l = E + r * Math.sin(C)),
              (f = Zt(s, l, n, r, a, 0, o, O, M, [C, k, x, E]));
          }
          S = C - w;
          var N = Math.cos(w),
            T = Math.sin(w),
            ...
            V = [s + L * R, l - D * I],
            j = [s, l];
          if (((P[0] = 2 * $[0] - P[0]), (P[1] = 2 * $[1] - P[1]), c))
            return [P, V, j].concat(f);
          for (
            var F = [],
              z = 0,
              B = (f = [P, V, j].concat(f).join().split(",")).length;
            z < B;
            z++
          )
            F[z] = z % 2 ? d(f[z - 1], f[z], p).y : d(f[z], f[z + 1], p).x;
          return F;
        }),
        Yt = Jt(
          function (e, t) {
                ...
                s = function (e, t, n) {
                  ...
                  switch (
                    ...
                    case "M":
                      ...
                      break;
                    case "A":
                      e = ["C"][Pt](Zt.apply(0, [t.x, t.y][Pt](e.slice(1))));
                      break;
                    case "S":
                      "C" == n || "S" == n
                        ? ((r = 2 * t.x - t.bx), (a = 2 * t.y - t.by))
                        : ((r = t.x), (a = t.y)),
                        (e = ["C", r, a][Pt](e.slice(1)));
                      break;
                    case "T":
                      "Q" == n || "T" == n
                        ? ((t.qx = 2 * t.x - t.qx), (t.qy = 2 * t.y - t.qy))
                        : ((t.qx = t.x), (t.qy = t.y)),
                        (e = ["C"][Pt](Xt(t.x, t.y, t.qx, t.qy, e[1], e[2])));
                      break;
                    case "Q":
                      (t.qx = e[1]),
                        (t.qy = e[2]),
                        (e = ["C"][Pt](Xt(t.x, t.y, e[1], e[2], e[3], e[4])));
                      break;
                    case "L":
                      e = ["C"][Pt](Qt(t.x, t.y, e[1], e[2]));
                      break;
                    case "H":
                      e = ["C"][Pt](Qt(t.x, t.y, e[1], t.y));
                      break;
                    case "V":
                      e = ["C"][Pt](Qt(t.x, t.y, t.x, e[1]));
                      break;
                    case "Z":
                      e = ["C"][Pt](Qt(t.x, t.y, t.X, t.Y));
                  }
                  return e;
                },
                l = function (e, t) {
                  if (e[t].length > 7) {
                    ...
                    for (var n = e[t]; n.length; )
                      (u[t] = "A"),
                        a && (h[t] = "A"),
                        e.splice(t++, 0, ["C"][Pt](n.splice(0, 6)));
                    e.splice(t, 1), (m = jt(r.length, (a && a.length) || 0));
                  }
                },
                    ...
                    if (n.name.endsWith(".svg")) {
                      ...
                      r.addEventListener("load", function () {
                        ...
                        try {
                          ...
                          console.error(
                            "Unexpected error happens when handling the SVG."
                          ),
                            console.error(e.toString());
                        }
                        for (
                          var n = t.querySelectorAll("path"), a = [], i = 0;
                          i < n.length;
                          i++
                        )
                          a.push(n[i].getAttribute("d"));
              ...
              (this.shared.cleanMode = this.controlConfig.clean),
                this.shared.currentExampleOption &&
                  (this.shared.currentExampleOption = Object.freeze(
                    Te(this.shared.currentExampleOption, this.optionPath, e)
                  ));
            },
          },
        },
        an = (n(39), Pe(rn, qe, [], !1, null, null, null));
      an.options.__file = "src/components/OptionControl.vue";
      var on = {
          name: "DocContentItemCard",
          props: ["nodeData", "descMap", "maxDepth", "depth"],
          components: { PropertiesList: He, OptionControl: an.exports },
          data: function () {
            return { manualExpanded: null, enableUIControl: !1, shared: ke };
          },
          watch: {
            enableUIControl: function (e) {
              e
                ? (this.shared.showOptionExample ||
          ...
          computed: {
            ...
            expanded: function () {
              return (
                !this.isLeaf &&
                (null != this.manualExpanded
                  ? this.manualExpanded
                  : this.depth < 2 ||
                    ke.currentPath.indexOf(this.nodeData.path) >= 0)
              );
            },
            isLeaf: function () {
            ...
            parentPath: function () {
              for (
                var e = this.nodeData.path.split("."), t = [], n = "", r = 0;
                r < e.length - 1;
                r++
              )
        ...
        sn = (n(40), Pe(on, ze, [], !1, null, null, null));
      sn.options.__file = "src/components/DocContentItemCard.vue";
      var ln = sn.exports,
        cn = n(24),
        un = n.n(cn),
        hn = function () {
          ...
          return n(
            "div",
            {
              class: e.shared.computedOptionExampleLayout + "-layout",
            ...
            [
              ...
              e.shared.currentExampleOption
                ? n(
                    ...
                    [
                      n("div", { staticClass: "preview-main" }),
                      e._v(" "),
                      e._m(0),
                      e._v(" "),
                      e.hasError
                        ? n("el-alert", {
                            attrs: {
                              title: e.$t("example.setOptionError"),
                              type: "error",
                            },
                          })
                        : e._e(),
                ...
                [
                  ...
                  n("el-button", {
                    ...
                    attrs: {
                      ...
                      size: "mini",
                      title: e.$t("example.changeLayout"),
                    },
                  }),
                  e._v(" "),
                  n("el-button", {
                    attrs: { size: "mini", circle: "", icon: "el-icon-close" },
                    on: { click: e.closeExamplePanel },
                  }),
                ],
                1
              ),
                        ...
                        n(
                          ...
                          e._l(e.optionExampleLayouts, function (t) {
                            return n(
                              "el-radio-button",
                              { key: t, attrs: { label: t } },
                              [e._v(e._s(e.$t("example.layout." + t)))]
                            );
                          }),
                          1
                        ),
      ...
      function xn(e, t, n, r, a, i, o, s) {
        ...
        for (c = 0; c <= f; c++)
          for (u = 0; u <= d; u++)
            if (0 === c) s[u] = u;
            else if (0 === u) (l = s[u]), (s[u] = c);
            else {
              var m =
                  l +
                  (o(e[h ? n - c : c - 1 + n], t[p ? a - u : u - 1 + a])
                    ? 0
                    : 2),
                v = s[u] + 1,
                g = s[u - 1] + 1;
              (l = s[u]), (s[u] = m < v ? m : v), g < s[u] && (s[u] = g);
            }
        return s;
      }
      var En,
        wn = function (e, t, n) {
          ...
          var i = e.length,
            ...
            s = Math.min(i, o),
            l = [];
          for (r = 0; r < s && n(e[r], t[r]); r++) yn(l, "=", r, r);
          for (a = 0; a < s && n(e[i - a - 1], t[o - a - 1]); a++);
          if (i - a >= r || o - a >= r) {
            var c = (function e(t, n, r, a, i, o, s, l, c) {
              var u,
                h,
                p = [],
                f = a - r,
              ...
              if (f)
                if (d)
                  if (1 === f) {
                    ...
                    var _ = ((f / 2) | 0) + r;
                    xn(t, n, r, _, i, o, s, l), xn(t, n, a, _ + 1, o, i, s, c);
                    var y,
                      b = 1 / 0,
                      x = 0;
                    for (h = 0; h <= d; h++)
                      (y = l[h] + c[d - h]) < b && ((b = y), (x = h));
                    p = e(t, n, r, _, i, (x += i), s, l, c);
                    var E = e(t, n, _, a, x, o, s, l, c);
                    for (u = 0; u < E.length; u++) p.push(E[u]);
                  }
                else for (u = 0; u < f; u++) yn(p, "-", u + r);
              else for (h = 0; h < d; h++) yn(p, "+", h + i);
              return p;
            })(e, t, r, i - a, r, o - a, n, [], []);
            for (r = 0; r < c.length; r++) l.push(c[r]);
            for (r = 0; r < a; r++) yn(l, "=", i - a + r, o - a + r);
          }
          return l;
        };
      function Cn(e, t) {
        ...
        if (r) {
          if (((this.hasError = !1), "undefined" == typeof echarts))
            (
              En ||
              (En = new Promise(function (e) {
                var t = document.createElement("script");
                (t.src =
                  "/third-party/cdn.jsdelivr.net/npm/echarts@4/dist/echarts.min.js"),
                  (t.async = !0),
                  (t.onload = function () {
                    e(), (En = null);
                  }),
          ...
          if (this.cmInstance) {
                    ...
                    return (
                      ...
                      s &&
                        setTimeout(function () {
                          n.scrollIntoView(
                            { line: o[0], ch: 0 },
                            n.getWrapperElement().clientHeight - 50
                          );
                        }, 20),
                      o
                    );
            ...
            this.cmInstance = fn()(this.$el.querySelector(".codemirror-main"), {
      ...
      var Sn = {
            ...
            (this.resize = this.resize.bind(this)),
              ...
              this.shared.allOptionExamples
                ? (this.shared.currentExampleName =
                    this.shared.allOptionExamples[0].name)
                : (this.shared.currentExampleName = "");
          },
          destroyed: function () {
            this.chartInstance &&
              (this.chartInstance.dispose(), (this.chartInstance = null)),
          ...
          methods: {
            updateOption: Cn,
            updateOptionThrottled: gn()(Cn, 300, { leading: !1 }),
            resize: function () {
              var e = this.$el;
              e.querySelector(".preview-main");
              "right" !== this.shared.computedOptionExampleLayout
                ? ((e.style.height = 0.5 * window.innerHeight - 60 + "px"),
                  (e.style.width = "auto"))
                : ((e.style.width = 0.45 * e.parentNode.clientWidth + "px"),
                  (e.style.height = "auto")),
          ...
          Pe(
            ...
            [
              function () {
                var e = this.$createElement,
                  t = this._self._c || e;
                return t("div", { staticClass: "example-code" }, [
                  t("div", { staticClass: "codemirror-main" }),
                ]);
              },
            ],
            !1,
      ...
      kn.options.__file = "src/components/LiveExample.vue";
      var On = kn.exports,
        Mn = {
          components: { DocContentItemCard: ln, LiveExample: On },
          data: function () {
            return {
              loading: !1,
              pagePath: "",
          ...
          computed: {
            ...
            pageDesc: function () {
              var e =
                this.rootPageDescMap[this.pagePath] ||
            ...
            pageDisplayOutline: function () {
              return this.shared.isMobile ? _e(Oe()) : this.pageOutline;
            },
            ...
            needScrollOffset: function () {
              return (
                this.shared.showOptionExample &&
                !this.shared.isMobile &&
                "top" === this.shared.computedOptionExampleLayout
              );
            },
          },
          created: function () {
          ...
          methods: {
            ...
            scrollTo: function (e, t, n) {
              var r = this;
              setTimeout(function () {
                var n = ke.isMobile ? 100 : 20;
                r.needScrollOffset &&
                  (n += r.$refs.liveExample.$el.offsetHeight),
                  Le()(document.getElementById(fe(e)), {
                    time: t || 400,
                    align: { top: 0, topOffset: n },
                  });
              }, n || 0);
            },
                        ...
                        .then(function (r) {
                          return (
                            ...
                            ge(e).then(function (a) {
                              n.pageOutline = Object.freeze(
                                Object.assign({}, r)
                              );
                              var i = {},
                                o = e.split(".")[0];
                              for (var s in a) i[o + "." + s] = a[s];
                              (n.pageDescMap = Object.freeze(i)),
                                (n.loading = !1),
                                n.scrollTo(e, 600, t ? 300 : 50),
                                n.updateLazyload();
                            })
                          );
                        })
            ...
            updateDocContentMargin: function (e) {
              if (
                (this.$refs.liveExample || e) &&
                ((this.$refs.docContentDom.style.margin = ""), !e)
              ) {
          ...
          watch: {
            ...
            pageExamples: function (e) {
              e && e.length
                ? (this.shared.allOptionExamples = Object.freeze(e))
        ...
        Nn = (n(44), Pe(Mn, Fe, [], !1, null, null, null));
      Nn.options.__file = "src/components/DocContent.vue";
      var Tn = Nn.exports,
        In = function () {
          var e = this,
            t = e.$createElement,
                  ...
                  scopedSlots: e._u([
                    {
                      ...
                      fn: function (t) {
                        ...
                        return [
                          n(
                            "div",
                            { staticClass: "doc-path-suggestion-item" },
                            [e._v(e._s(r.path))]
                          ),
                        ];
                      },
      ...
      var Rn = {
          data: function () {
            return { queryString: ke.searchQuery, shared: ke };
          },
          computed: {},
          methods: {
                ...
                ? (function (e) {
                    ...
                    return de().then(function () {
                      ...
                      if (n.length < t) {
                        ...
                        for (var i = 0, o = 0; o < he.length; o++)
                          (le[o] = 255 * Object(ae.stringSimilarity)(he[o], e)),
                            le[o] > 50 && i++;
                        for (var s = {}, l = 0; n.length < t && i > 0; ) {
                          for (var c = 0, u = void 0, h = 0; h < le.length; h++)
                            le[h] > c && !s[h] && ((u = h), (c = le[h]));
                          if (
                            (c > 50 && ((s[u] = !0), n.push(_e(he[u])), i--),
                            ++l > 200)
                          )
                            break;
                        }
            ...
            fuzzySearch: function () {
              (this.shared.searchQuery = this.queryString),
                Re("/search/" + this.shared.searchQuery);
            },
          },
        },
        An = (n(45), Pe(Rn, In, [], !1, null, null, null));
      An.options.__file = "src/components/Search.vue";
      var Ln = An.exports,
        Dn = function () {
          var e = this,
            t = e.$createElement,
          ...
          return n(
            ...
            [
                  ...
                  "\n        " +
                    e._s(
                      e
                        ...
                        .replace("${searchResultCount}", e.searchResultCount)
                    ) +
                    ",\n        "
                ),
                e.searchToken
                  ? n("span", { staticClass: "searching" }, [
                      e._v("\n            搜索中"),
              ...
              e._l(e.searchResult, function (t) {
                return n("SearchResultItemCard", {
                  key: t.path,
                  attrs: {
                    "item-data": t,
                    "search-query": e.shared.searchQuery,
                  },
                });
              }),
            ],
      ...
      var $n = function () {
        ...
        return n(
          ...
          {
            class: {
              "doc-search-result-item-card": !0,
              "needs-show-more": e.needsShowMoreDesc,
            },
          },
          [
            n(
              ...
              [
                n(
                  ...
                  {
                    staticClass: "path",
                    attrs: { href: "#" + e.itemData.path },
                  },
                  [e._v(e._s(e.itemData.path))]
                ),
              ]
            ),
            e._v(" "),
      ...
      var Pn = {
        ...
        Vn = (n(46), Pe(Pn, $n, [], !1, null, null, null));
      function jn(e) {
        var t = this;
      ...
      Vn.options.__file = "src/components/SearchResultItemCard.vue";
      var Fn = {
          components: { SearchResultItemCard: Vn.exports },
          data: function () {
            return {
              searchResult: [],
              searchResultCount: 0,
          ...
          methods: {
            updateSearchResultsImmediate: jn,
            updateSearchResults: gn()(jn, 500, { leading: !1 }),
          },
          watch: {
        ...
        zn = (n(47), Pe(Fn, Dn, [], !1, null, null, null));
      zn.options.__file = "src/components/SearchResult.vue";
      var Bn = zn.exports,
        Wn = function () {
          var e = this.$createElement;
      ...
      Wn._withStripped = !0;
      var Un = Pe({}, Wn, [], !1, null, null, null);
      Un.options.__file = "src/components/Home.vue";
      var Hn = Un.exports,
        qn = {
          props: ["docType"],
          data: function () {
        ...
        Gn = (n(48), Pe(qn, Z, [], !1, null, null, null));
      Gn.options.__file = "src/App.vue";
      var Kn = Gn.exports,
        Jn = function () {
          var e = this,
            t = e.$createElement,
      ...
      var Qn = {
          ...
          computed: {
            ...
            pagePathParts: function () {
              for (
                var e = this.pagePath.split("."), t = [], n = "", r = 0;
                r < e.length;
                r++
              )
                (n += n ? "." + e[r] : e[r]),
                  t.push({
                    text: e[r] + (r === e.length - 1 ? "" : "."),
                    link: n,
                  });
              return t;
            },
        ...
        Xn = (n(49), Pe(Qn, Jn, [], !1, null, null, null));
      Xn.options.__file = "src/AppMobile.vue";
      var Zn = Xn.exports,
        Yn = n(20),
        er = n.n(Yn),
        tr = n(27),
      ...
      function ir(e) {
        e.querySelectorAll("pre code").forEach(function (e) {
          e.classList.contains("hljs") || er.a.highlightBlock(e);
        });
      }
      er.a.registerLanguage("javascript", nr.a),
        er.a.registerLanguage("xml", ar.a),
      ...
      function ur(e, t) {
        ...
        e.__markInstance
          ...
          : ((e.__markInstance = new sr.a(e)), n());
      }
      function hr() {
        window.innerWidth < 600 ? (ke.isMobile = !0) : (ke.isMobile = !1);
      }
      a.a.directive("mark", {
        inserted: function (e, t) {
          (e.__doMarkDebounced = cr()(ur, 500, { trailing: !0, leading: !1 })),
      ...
      var pr = {
        en: {
          ...
          example: {
            ...
            setOptionError:
              "Something Unexpected Happerns. Click refresh to try again!",
            refresh: "Refresh",
            close: "Close",
      ...
      function fr(e, t) {
        ...
        me(t.baseUrl, n, t.docType, t.version).then(function () {
          ...
          new a.a({
            ...
            render: function (e) {
              return (
                console.log("iMobile: ", ke.isMobile),
                ke.isMobile ? e(Zn) : e(Kn)
              );
            },
          });
        });
