for (
  var lang = {
      zh: { errorInEditor: "编辑器内容有误！", chartOK: "图表已生成, " },
      en: {
    ...
    configs = {},
    lnTools = ace.require("ace/ext/language_tools"),
    keywords = {
      grid: 108210,
      series: 1161721,
      pie: 173151,
...
function makeSearch(e) {
  var t,
    o = [];
  for (t in e) null != e[t] && o.push(t + "=" + e[t]);
  return o.join("&");
}
...
function setEchartsVersionButton(e) {
  $("#echarts-version-btn").html(
    "ECharts-" + e + ' <span class="caret"></span>'
  ),
...
function setSplitPosition(e) {
  e = 100 * (e = Math.min(0.9, Math.max(0.1, e)));
  $("#code-container").css("width", e + "%"),
    $(".right-container")
      .css("width", 100 - e + "%")
      .css("left", e + "%"),
    $("#h-handler").css("left", e + "%"),
    gb.chart && (gb.chart.resize(), appEnv.onresize && appEnv.onresize());
}
function checkEditorIfToShow() {
  window.innerWidth < 768
    ? (void 0 !== gb.editorIsShown && !0 !== gb.editorIsShown) ||
      ($("#code-container").hide(),
      $("#h-handler").hide(),
      $(".right-container").css("width", "100%").css("left", "0%"),
      (gb.editorIsShown = !1))
    : (void 0 !== gb.editorIsShown && !1 !== gb.editorIsShown) ||
      ($("#code-container").show(),
      $("#h-handler").show(),
...
$("#theme ." + (configs.theme || "default")).addClass("selected"),
  $("#theme a").click(function () {
    ...
    $(this).hasClass("selected") ||
      ((e = $(this).attr("class").replace("default", "").trim()),
...
(window.setTimeout = function (e, t) {
  t = _oldSetTimeout(e, t);
  return _timeoutIdList.push(t), t;
}),
  (window.setInterval = function (e, t) {
    t = _oldSetInterval(e, t);
    return _intervalIdList.push(t), t;
  });
var _events = [];
      ...
      try {
        ...
        if (
          ...
          option &&
            ...
            (!_.isEqual(option, gb.lastOption) || ignoreOptionNotChange))
        ) {
          ...
          for (
            var debounceTime = 500,
              debounceTimeQuantities = [500, 2e3, 5e3, 1e4],
              i = debounceTimeQuantities.length - 1;
            0 <= i;
            i--
          ) {
        ...
        if (
          (gui && ($(gui.domElement).remove(), gui.destroy(), (gui = null)),
          app.config)
        ) {
          (gui = new dat.GUI({ autoPlace: !1 })),
            $(gui.domElement).css({
              position: "absolute",
              right: 5,
              top: 0,
          ...
          for (name in app.config) {
            ...
            if ("onChange" !== name && "onFinishChange" !== name) {
              ...
              if (
                (configParameters[name] &&
                  (configParameters[name].options
                    ...
                    : null != configParameters[name].min &&
                      (controller = gui.add(
                        app.config,
                        name,
              ...
              (controller =
                controller ||
                gui[isColor ? "addColor" : "add"](app.config, name)),
        ...
        log(lang.errorInEditor, "error"), console.error(e);
      }
    }
  },
...
function hasEditorError() {
  for (
    var e = gb.editor.getSession().getAnnotations(), t = 0, o = e.length;
    t < o;
    ++t
  )
...
function load() {
  var e,
    t = configs.gl ? "data-gl" : "data";
  function o() {
    configs.c &&
      (console.log(configs.c),
      $.ajax(
        window.CDN_PAY_ROOT_PATH +
          "/" +
          t +
          "/" +
          configs.c +
  ...
  configs.gl
    ? (((e = document.createElement("script")).onload = function () {
      ...
      (e.src = window.CDN_THIRD_PARTY_ECHARTS_GL),
...
function log(e, t) {
  ...
  "warn" !== t && "error" !== t && (t = "info"),
    $("#code-info").html(
      '<span class="code-info-time">' +
        o +
        '</span><span class="code-info-type-' +
        t +
        '">' +
        e +
        "</span>"
...
function formatTime(e) {
  for (
    var t = [e.getHours(), e.getMinutes(), e.getSeconds()],
      o = "",
      n = 0,
      a = t.length;
    n < a;
    ...
    (o += (t[n] < 10 ? "0" : "") + t[n]), n < a - 1 && (o += ":");
  return o;
}
function getVersion() {
  var e = window.location.href.split("/");
  return (4 !== e.length && parseInt(e[e.length - 1], 10)) || 1;
}
function getCid() {
...
function downloadExample() {
  var e =
      '<!DOCTYPE html>\n<html style="height: 100%">\n   <head>\n       <meta charset="utf-8">\n   </head>\n   <body style="height: 100%; margin: 0">\n       <div id="container" style="height: 100%"></div>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts@4/dist/echarts.min.js"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts-gl@1/dist/echarts-gl.min.js"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts-stat@1/dist/ecStat.min.js"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts@4/dist/extension/dataTool.min.js"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts@4/map/js/china.js"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts@4/map/js/world.js"></script>\n       <script type="text/javascript" src="https://api.map.baidu.com/api?v=2.0&ak=xfhhaTThl11qYVrqLZii6w8qE5ggnhrY&__ec_v__=20190126"></script>\n       <script type="text/javascript" src="/third-party/cdn.jsdelivr.net/npm/echarts@4/dist/extension/bmap.min.js"></script>\n       <script type="text/javascript">\nvar dom = document.getElementById("container");\nvar myChart = echarts.init(dom);\nvar app = {};\noption = null;\n' +
      gb.editor.getValue() +
      ';\nif (option && typeof option === "object") {\n    myChart.setOption(option, true);\n}\n       </script>\n   </body>\n</html>',
    t = new Blob([e], { type: "text/html;charset=UTF-8", encoding: "UTF-8" }),
    e = document.createElement("a");
  (e.href = URL.createObjectURL(t)),
    (e.download = configs.c + ".html"),
    e.click();
}
