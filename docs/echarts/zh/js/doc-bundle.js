  ...
  return (function (e) {
    ...
    function (e, t) {
        ...
        for (u = 0; u <= d; u++)
          for (h = 0; h <= m; h++)
            if (0 === u) l[h] = h;
              ...
              var v =
                  c +
                  (s(e[p ? n - u : u - 1 + n], t[f ? i - h : h - 1 + i])
                    ? 0
                    : 2),
                g = l[h] + 1,
                _ = l[h - 1] + 1;
              (c = l[h]), (l[h] = v < g ? v : g), _ < l[h] && (l[h] = _);
            }
        return l;
      }
      var o = function (e, t, a) {
        ...
        var l = e.length,
          ...
          u = Math.min(l, c),
          h = [];
        for (o = 0; o < u && a(e[o], t[o]); o++) r(h, "=", o, o);
        for (s = 0; s < u && a(e[l - s - 1], t[c - s - 1]); s++);
        if (l - s >= o || c - s >= o) {
          var p = (function e(t, n, a, o, s, l, c, u, h) {
            var p,
              f,
              d = [],
              m = o - a,
            ...
            if (m)
              if (v)
                if (1 === m) {
                  ...
                  var b = ((m / 2) | 0) + a;
                  i(t, n, a, b, s, l, c, u), i(t, n, o, b + 1, l, s, c, h);
                  var x,
                    E = 1 / 0,
                    w = 0;
                  for (f = 0; f <= v; f++)
                    (x = u[f] + h[v - f]) < E && ((E = x), (w = f));
                  d = e(t, n, a, b, s, (w += s), c, u, h);
                  var C = e(t, n, b, o, w, l, c, u, h);
                  for (p = 0; p < C.length; p++) d.push(C[p]);
                }
              else for (p = 0; p < m; p++) r(d, "-", p + a);
            else for (f = 0; f < v; f++) r(d, "+", f + s);
            return d;
          })(e, t, o, l - s, o, c - s, a, [], []);
          for (o = 0; o < p.length; o++) h.push(p[o]);
          for (o = 0; o < s; o++) r(h, "=", l - s + o, c - s + o);
        }
        return h;
      };
      e.exports = o;
    ...
    function (e, t, n) {
          ...
          [
            ...
            n("h4", [
              ...
              e.shared.currentPath === e.nodeData.path
                ? n("span", { staticClass: "current-flag" }, [
                    n("i", { staticClass: "el-icon-caret-left" }),
                  ])
                : e._e(),
              e._v(" "),
      ...
      var We = {
        ...
        Ue = (n(33), Pe(We, Be, [], !1, null, null, null));
      ...
      var Ke = {
        ...
        Je = (n(34), Pe(Ke, Ge, [], !1, null, null, null));
      ...
      var tt = {
        ...
        nt = (n(35), Pe(tt, et, [], !1, null, null, null));
      ...
      var it = {
        ...
        ot = (n(36), Pe(it, at, [], !1, null, null, null));
      ...
      var ct = { true: !0, false: !1 },
        ...
        ht = (n(37), Pe(ut, lt, [], !1, null, null, null));
      ...
      var dt = {
        ...
        mt = (n(38), Pe(dt, ft, [], !1, null, null, null));
      ...
      var _t = {
        ...
        yt = (n(39), Pe(_t, gt, [], !1, null, null, null));
      ...
      var rn = {
        ...
        an = (n(40), Pe(rn, qe, [], !1, null, null, null));
      ...
      var on = an.exports,
        ...
        ln = {
          ...
          components: { PropertiesList: He, OptionControl: on },
          data: function () {
          ...
          computed: {
            ...
            expanded: function () {
              ...
              return (
                (this.depth < 2 && sn.indexOf(e.pop()) < 0) ||
        ...
        cn = (n(41), Pe(ln, ze, [], !1, null, null, null));
      ...
      function wn(e, t) {
        ...
        if (r) {
          if (((this.hasError = !1), "undefined" == typeof echarts))
            (
              dn ||
              (dn = new Promise(function (e) {
                var t = document.createElement("script");
                (t.src =
                  "/third-party/cdn.jsdelivr.net/npm/echarts@5/dist/echarts.min.js"),
                  (t.async = !0),
                  (t.onload = function () {
                    e(), (dn = null);
                  }),
          ...
          if (this.cmInstance) {
            ...
            this.cmInstance = vn()(this.$el.querySelector(".codemirror-main"), {
      ...
      var Cn = {
          ...
          methods: {
            updateOption: wn,
            updateOptionThrottled: bn()(wn, 300, { leading: !1 }),
            resize: function () {
              var e = this.$el;
      ...
      Sn.options.__file = "src/components/LiveExample.vue";
      var kn = Sn.exports,
        On = {
          components: { DocContentItemCard: un, LiveExample: kn },
          data: function () {
            return {
              loading: !1,
              pagePath: "",
        ...
        Mn = (n(45), Pe(On, Fe, [], !1, null, null, null));
      Mn.options.__file = "src/components/DocContent.vue";
      var Nn = Mn.exports,
        Tn = function () {
          var e = this,
            t = e.$createElement,
      ...
      var In = {
        ...
        Rn = (n(46), Pe(In, Tn, [], !1, null, null, null));
      Rn.options.__file = "src/components/Search.vue";
      var An = Rn.exports,
        Ln = function () {
          var e = this,
            t = e.$createElement,
      ...
      var $n = {
        ...
        Pn = (n(47), Pe($n, Dn, [], !1, null, null, null));
      function Vn(e) {
        var t = this;
      ...
      Pn.options.__file = "src/components/SearchResultItemCard.vue";
      var jn = {
          components: { SearchResultItemCard: Pn.exports },
          data: function () {
            return {
              searchResult: [],
              searchResultCount: 0,
          ...
          methods: {
            updateSearchResultsImmediate: Vn,
            updateSearchResults: bn()(Vn, 500, { leading: !1 }),
          },
          watch: {
        ...
        Fn = (n(48), Pe(jn, Ln, [], !1, null, null, null));
      Fn.options.__file = "src/components/SearchResult.vue";
      var zn = Fn.exports,
        Bn = function () {
          var e = this.$createElement;
      ...
      Bn._withStripped = !0;
      var Wn = Pe({}, Bn, [], !1, null, null, null);
      Wn.options.__file = "src/components/Home.vue";
      var Un = Wn.exports,
        Hn = {
          props: ["docType"],
          data: function () {
        ...
        qn = (n(49), Pe(Hn, Z, [], !1, null, null, null));
      qn.options.__file = "src/App.vue";
      var Gn = qn.exports,
        Kn = function () {
          var e = this,
            t = e.$createElement,
      ...
      var Jn = {
        ...
        Qn = (n(50), Pe(Jn, Kn, [], !1, null, null, null));
      Qn.options.__file = "src/AppMobile.vue";
      var Xn = Qn.exports,
        Zn = n(20),
        Yn = n.n(Zn),
        er = n(28),
      ...
      function ar(e) {
        e.querySelectorAll("pre code").forEach(function (e) {
          e.classList.contains("hljs") || Yn.a.highlightBlock(e);
        });
      }
      Yn.a.registerLanguage("javascript", tr.a),
        Yn.a.registerLanguage("xml", rr.a),
      ...
      a.a.directive("mark", {
        inserted: function (e, t) {
          (e.__doMarkDebounced = lr()(cr, 500, { trailing: !0, leading: !1 })),
      ...
      function pr(e, t) {
        window.addEventListener("resize", ur), ur();
