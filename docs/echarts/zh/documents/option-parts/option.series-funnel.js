window.__EC_DOC_option_series_funnel = {
  ...
  label: {
    desc: "<p>漏斗图图形上的文本标签，可用于说明图形的一些数据信息，比如值，名称等。</p>\n",
  },
  "label.position": {
  ...
  "data.itemStyle.height": {
    desc: '<p>该数据项的高度。默认平均分配高度，如果需要修改，可以将其设为百分比（如：<code class="codespan">&#39;10%&#39;</code>）或像素值（如：<code class="codespan">20px</code>）。需要注意总和应为 100%。</p>\n',
  },
